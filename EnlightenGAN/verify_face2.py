...
res_enh = evaluate('C:/Users/Vignesh M/PycharmProjects/Thesis/dataset/lfw_test_classical', 'classical')
...
plt.plot(res_enh['fpr'], res_enh['tpr'], label=f'classical (AUC = {res_enh["auc"]:.2f})')
...
enh_embs, enh_labels = get_embeddings_for_pca('C:/Users/Vignesh M/PycharmProjects/Thesis/dataset/lfw_test_classical', 'Classical')
...
plt.grid(True)
plt.tight_layout()
output_path = "C:/Users/Vignesh M/PycharmProjects/Thesis/embedding_pca1.png"
