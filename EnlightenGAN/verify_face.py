...
res_enh = evaluate('C:/Users/Vignesh M/PycharmProjects/Thesis/dataset/lfw_test_enhanced', 'Enhanced')
...
plt.plot(res_enh['fpr'], res_enh['tpr'], label=f'Enhanced (AUC = {res_enh["auc"]:.2f})')
...
enh_embs, enh_labels = get_embeddings_for_pca('C:/Users/Vignesh M/PycharmProjects/Thesis/dataset/lfw_test_enhanced', 'Enhanced')
...
# Plotting
colors = {'Clean': 'blue', 'Dark': 'red', 'Enhanced': 'green'}
...
plt.grid(True)
plt.tight_layout()
output_path = "C:/Users/Vignesh M/PycharmProjects/Thesis/embedding_pca.png"
